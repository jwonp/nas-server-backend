...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Folder',
            fields=[
                ('folder_name', models.CharField(db_column='folder_name', max_length=100, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='File',
            fields=[
                ('file_name', models.CharField(db_column='file_name', max_length=100, primary_key=True, serialize=False)),
